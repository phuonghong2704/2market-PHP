...
<body>
    <form action="xulydoipass2.php" method="post" id="frmlogin" onsubmit="return validateFormDoiPass()">
        <div class="logo">
            <a href="../../index.php"><img src="../images/1.png" width="25%" height="20%"></a>
        </div>
        <br>
        <div class="tex">
            <input name="username" type="text" disabled value="<?=$u;?>" placeholder="Tên Người Dùng">
        </div>
        ...
        <div class="tex">
            <input name="pass_new2" id="re_pass_new" type="password" placeholder="Nhập Mật Khẩu mới">
        </div>
